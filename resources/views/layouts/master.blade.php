...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="">
                <a href="index.html" class="text-info"><img src="{{ asset('assets/icons/icon-kabupaten.png') }}" alt="Logo" style="height:30px"> AYO LAPOR!</a>
            </div>
                                            ...
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    <svg class="bi text-primary" width="32" height="32" fill="blue"
                                                        style="width:10px">
                                                        <use
                                                            xlink:href="{{ asset('assets/template/assets/images/bootstrap-icons.svg#circle-fill') }}" />
                                                    </svg>
                                                ...
                                                <tbody>
                                                        ...
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="{{ asset('assets/template/assets/images/faces/5.jpg') }}">
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="{{ asset('assets/template/assets/images/faces/2.jpg') }}">
                                                                </div>
                            ...
                            <div class="card-content pb-4">
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="{{ asset('assets/template/assets/images/faces/4.jpg') }}">
                                    </div>
                                    <div class="name ms-4">
                                ...
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="{{ asset('assets/template/assets/images/faces/1.jpg') }}">
                                    </div>
                                    <div class="name ms-4">
